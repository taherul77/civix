  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<button className="btn btn-primary"><Plus className="w-4 h-4" /> Invite user</button>}
      />
      ...
      <div className="card overflow-hidden">
        <div className="overflow-x-auto">
          <table className="civix">
            <thead>
              <tr><th>Name</th><th>Email</th><th>Role</th><th>Department</th><th>MFA</th><th>Status</th></tr>
            </thead>
            <tbody>
              {users.map((u) => (
                <tr key={u.id}>
